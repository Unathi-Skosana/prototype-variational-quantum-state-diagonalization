...
from vqsd.utils.meas_mit_filters_faster import MeasurementFilter
...
class CompleteMeasFitter:
    ...
    def __init__(
        ...
        if qubit_list is None:
            qubit_list = np.arange(state_labels[0], dtype=int).tolist()
